...
//        //[Fact]
//        //public void PostCreateGameLastStepRouteShouldBeMapped()
//        //    => MyRouting
//        //        .Configuration()
//        //        .ShouldMap(request => request
//        //            .WithPath("/Games/CreateGameLastStep")
//        //            .WithMethod(HttpMethod.Post))
//        //        .To<GamesController>(c => c.CreateGameLastStep(With.Any<CreateGameLastStepViewModel>()));
...
//        //        .Configuration()
//        //        .ShouldMap(request => request
//        //            .WithPath("/Games/Details"))
//        //        .To<GamesController>(c => c.Details(1, "asd"));
